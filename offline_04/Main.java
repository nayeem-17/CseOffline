...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(d[0].getMaxSalaryEmployee().getName()); // prints the name of the employee with highest
                                                                   // salary in this department
        System.out.println(d[1].getMaxSalaryEmployee().getName()); // prints the name of the employee with highest
                                                                   // salary in this department
